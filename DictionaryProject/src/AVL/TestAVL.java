...
public class TestAVL {
    public static void main(String[] args) throws Exception {
        ...
        DictionaryAVLTree dictionary = selectLoading();
        dictionary.counter();
    ...
    private static void initiate_Methods(DictionaryAVLTree dictionary, int choice) throws WordNotFoundException, InterruptedException, IOException, WordAlreadyExistsException {
    ...
    public static DictionaryAVLTree selectLoading(){
        Scanner scan = new Scanner(System.in);
        ...
        if(choice == 1){
            ...
            try {   
                ...
                DictionaryAVLTree dictionary = new DictionaryAVLTree(file);
                return dictionary;
            } catch (Exception e) {
